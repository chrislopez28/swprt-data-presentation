...
* Example uses of R with **stormwater data**
* Strengths, weaknesses, perspectives
...
- Renewing Region 4 Phase I MS4 Permits
    + Need to evaluate monitoring data (~50 TMDLs) before permit consideration
    + Need to present our analysis to the LA Regional Board in a series of 3 workshops (*did this earlier this year*)
    + Need to produce a monitoring data review report that goes over all the data (*working on finishing right now*)
...
<img src="images/xkcd_00.png" align="right" margin="0 auto" />
